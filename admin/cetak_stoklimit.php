...
<body>
    <div align="center">
		...
		<h3 style="margin-left: -2%; margin-top: -15px;"><?php echo "LAPORAN STOK LIMIT"; ?></h3>
		<?php
        ...
        <table style="margin-top: 15px;" border="1" id="dataTable" width="800" cellspacing="0">
            ...
            <?php
            $query = mysqli_query($con, "SELECT * FROM produk LEFT JOIN kategori ON produk.id_kategori=kategori.id_kategori WHERE produk.stok <=5 ORDER BY produk.stok ASC");
            $no = 0;
