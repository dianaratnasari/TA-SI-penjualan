...
<body>
    <div align="center">
        <span class="noprint">
            ...
            <a class="noprint" href="../index.php?hal=transaksi">Kembali</a>
        ...
        <form class="form-transaksibayar">
            ...
            <h4 class="nama-nota" style="margin-top: -5px;">
            <?php
           ...
           <h4 style="margin-top: -23px; margin-left: -290px;"> Admin : <?= $row['username'] ?> </h4>
            ...
            detail_transaksi.id_produk=produk.id_produk WHERE detail_transaksi.id_transaksi='$_GET[idtran]'");
